...
handlers._order.post = (data, callback)=>{
    ...
    const expMonth = typeof(data.payload.expmonth)=="number" && data.payload.expmonth>=1 && data.payload.expmonth<=12 ? data.payload.expmonth : false;
    const expYear = typeof(data.payload.expyear)=="number" && data.payload.expyear>=2018 ? data.payload.expyear : false;
    const cvv = typeof(data.payload.cvv)=="number" ? data.payload.cvv : false;
